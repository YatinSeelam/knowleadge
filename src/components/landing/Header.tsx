            ...
            <div className="space-y-4">
              {user ? (
                ...
                <div className="space-y-4">
                  ...
                  {/* Custom Sign In Button for Mobile - Improved styling */}
                  <motion.button
                    whileTap={{ scale: 0.95 }}
                    onClick={handleMobileSignIn}
                    className="w-full flex items-center justify-center space-x-3 px-6 py-3 bg-blue-500 text-white border-2 border-gray-800 rounded-lg shadow-[4px_4px_0_0_rgb(17,24,39)] hover:shadow-[6px_6px_0_0_rgb(17,24,39)] hover:bg-blue-600 transition-all duration-200"
                  >
